...
import userSix from '../images/user/Admin.png';
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={userSix} alt="profile" className='rounded-full w-52 h-40 ' />
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              Fares Khleifi is a dedicated full-stack developer and an IT Management student.
               With a passion for technology and innovation, Fares combines technical expertise 
               with management skills to deliver
               comprehensive software solutions. His work spans front-end and back-end development,
            ...
            <div className="mt-6.5">
              ...
              <div className="flex items-center justify-center gap-3.5">
                <a
                  href="https://www.facebook.com/fares.khlaifi"
                ...
                <a
                  href="https://x.com/Farees_khleifi"
                  className="hover:text-primary"
                  aria-label="social-icon"
                  target='_blank'
                >
                ...
                <a
                  href="https://www.linkedin.com/in/fares-khleifi-a617791a1/"
                  className="hover:text-primary"
                  aria-label="social-icon"
                  target='_blank'
                >
                ...
                <a
                  href="https://github.com/Fareskhleifi"
                  className="hover:text-primary"
                  aria-label="social-icon"
                  target='_blank'
                >
